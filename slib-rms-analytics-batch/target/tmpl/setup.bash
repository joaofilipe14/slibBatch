...
set_java() {
  ...
  local java_options="{{<<app-tile-ph-prefix>>.java.options}}"
  [[ $java_options ]] && export _JAVA_OPTIONS=$java_options
}

app_home=/home/data{{shared.env.code}}/<<app-tile-app-id>>
...
log_file=/home/data{{shared.env.code}}/var/log/<<app-tile-app-id>>/<<app-tile-app-id>>.log
